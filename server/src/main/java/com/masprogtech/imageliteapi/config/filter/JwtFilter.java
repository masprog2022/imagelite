package com.masprogtech.imageliteapi.config.filter;

import com.masprogtech.imageliteapi.application.jwt.InvalidTokenException;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    public void setUserAsAuthenticated(User user){
